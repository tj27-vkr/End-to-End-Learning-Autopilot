...
## Parameters
import variables ## you can modify the content of variables
...
def save_model(model, epoch=''):
    ...
    :return: None
    """
    model_path = join_dir(variables.model_dir, 'model_{}.json'.format(epoch))
    param_path = join_dir(variables.model_dir, 'model_{}.h5'.format(epoch))
    #
...
def get_model():
    ...
    """
    model_path = join_dir(variables.model_dir, 'model.json')
    param_path = join_dir(variables.model_dir, 'model.h5')
...
if __name__ == '__main__':
    ...
    # frame_count_limit = 1
    visualize(epoch_id, machine_steering, variables.out_dir,
